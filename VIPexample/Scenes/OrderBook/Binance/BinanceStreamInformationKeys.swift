...
enum BinanceStreamInformationKeys {
    case tradeStreams(symbols: [String]) /// <symbol>@trade
    case candleSticks(symbol: String, interval: String) ///  <symbol>@kline_<interval>
    case individualSymbolMiniTicker(symbol: String) ///  <symbol>@miniTicker
    case individualSymbolTicker(symbol: String) /// <symbol>@ticker
    case allMarketMiniTickerStream /// !miniTicker@arr
    case allMarketTickerStream /// !ticker@arr
    case individualSymbolBookTicker(symbol: String) /// <symbol>@bookTicker
    case allBookTickerStream /// !bookTicker
    ...
    func composeStreamNameAndSettings() -> [String] {
        switch self {
